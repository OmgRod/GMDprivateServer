...
$binaryVersion = !empty($_POST["binaryVersion"]) ? abs(Escape::number($_POST["binaryVersion"])) : 1;
$coins = !empty($_POST["coins"]) ? abs(Escape::number($_POST["coins"])) : 0;
$iconType = !empty($_POST["iconType"]) ? abs(Escape::number($_POST["iconType"])) : 0;
$userCoins = !empty($_POST["userCoins"]) ? abs(Escape::number($_POST["userCoins"])) : 0;
$special = !empty($_POST["special"]) ? abs(Escape::number($_POST["special"])) : 0;
$accIcon = !empty($_POST["accIcon"]) ? abs(Escape::number($_POST["accIcon"])) : 0;
$accShip = !empty($_POST["accShip"]) ? abs(Escape::number($_POST["accShip"])) : 0;
$accBall = !empty($_POST["accBall"]) ? abs(Escape::number($_POST["accBall"])) : 0;
$accBird = !empty($_POST["accBird"]) ? abs(Escape::number($_POST["accBird"])) : 0;
$accDart = !empty($_POST["accDart"]) ? abs(Escape::number($_POST["accDart"])) : 0;
$accRobot = !empty($_POST["accRobot"]) ? abs(Escape::number($_POST["accRobot"])) : 0;
$accGlow = !empty($_POST["accGlow"]) ? abs(Escape::number($_POST["accGlow"])) : 0;
$accSpider = !empty($_POST["accSpider"]) ? abs(Escape::number($_POST["accSpider"])) : 0;
$accExplosion = !empty($_POST["accExplosion"]) ? abs(Escape::number($_POST["accExplosion"])) : 0;
$diamonds = !empty($_POST["diamonds"]) ? abs(Escape::number($_POST["diamonds"])) : 0;
$moons = !empty($_POST["moons"]) ? abs(Escape::number($_POST["moons"])) : 0;
$color3 = !empty($_POST["color3"]) ? abs(Escape::number($_POST["color3"])) : 0;
$accSwing = !empty($_POST["accSwing"]) ? abs(Escape::number($_POST["accSwing"])) : 0;
$accJetpack = !empty($_POST["accJetpack"]) ? abs(Escape::number($_POST["accJetpack"])) : 0;
$dinfo = !empty($_POST["dinfo"]) ? Escape::multiple_ids($_POST["dinfo"]) : '';
$dinfow = !empty($_POST["dinfow"]) ? abs(Escape::number($_POST["dinfow"])) : 0;
$dinfog = !empty($_POST["dinfog"]) ? abs(Escape::number($_POST["dinfog"])) : 0;
$sinfo = !empty($_POST["sinfo"]) ? Escape::multiple_ids($_POST["sinfo"]) : '';
$sinfod = !empty($_POST["sinfod"]) ? abs(Escape::number($_POST["sinfod"])) : 0;
$sinfog = !empty($_POST["sinfog"]) ? abs(Escape::number($_POST["sinfog"])) : 0;
